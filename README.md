...
- <b><a href="[https://github.com/ChaimaHaffar/Titanic---Machine-Learning-from-Disaster"> Titanic - Machine Learning from Disaster A machine learning project : </a></b>predicting passenger survival on the Titanic using the Kaggle Titanic dataset. Includes data preprocessing, feature encoding, train/test split, and evaluation of a Logistic Regression model with Accuracy, AUC, Precision, Recall, F1-score, and Confusion Matrix.
